...
def repeat_kv(hidden_states: torch.Tensor, n_rep: int) -> torch.Tensor:
    ...
    # Torch: [1, 8, seq_len, 128] -> [1, 8, 4, seq_len, 128] -> [1, 32, seq_len, 128]
    
    # New: [1, seq_len, 8, 128] -> [1, 8, seq_len 128] -> 
...
class LlamaDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # Self Attention
        hidden_states, self_attn_weights, present_key_value = self.self_attn( #return attn_output, attn_weights, past_kv
            hidden_states=hidden_states,
            attention_mask=attention_mask,
            position_ids=position_ids,
            past_key_value=past_key_value,
    ...
    def forward(
        ...
        for decoder_layer in self.layers:
            ...
            if self.gradient_checkpointing and self.training:
                ...
                layer_outputs = decoder_layer( # return attn_output, attn_weights, past_kv
                    hidden_states,
